          ...
          <div className="md:grid md:grid-cols-3 grid-cols-2 md:gap-0 gap-14">
            <div className="md:order-first ">
              <ul>
                <li>
                  <Link href="#">
                    <a className="md:text-sm text-[10px] text-white">
                      client@jiwandhillon.ca
                    </a>
                  </Link>
                </li>
                <li>
            ...
            <div className="grid gap-3 mb-3 md:mb-0 md:gap-14 md:col-span-1 col-span-2 md:order-first order-last">
              <h2 className="font-ITCGaramondLightCondensed tracking-tighter md:text-[27px] text-[22px] md:text-center text-white">
                © Jiwan Dhillon & Company CPA
              </h2>
              <p className="font-AdobCaslonRegular italic md:text-base text-xs text-left md:text-center text-white">
                c/o Maker Brothers Worldwide®
              </p>
            </div>
            <div>
